...
public interface OrderBook {
	...
	public double executeMarketOrder(GenericPlayer investor,String ruleID,OrderType type, double price, int quantity,int orderMark) throws LiquidityException;
	...
	// otherwise
	public boolean placeLimitOrder(LimitOrder order,int orderMark);
