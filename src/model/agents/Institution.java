...
public class Institution extends GenericPlayer {
...
//	public double wealth; // wealth, initial wearlth w=So*Po;
    ...
    private void checkAnnouncement() {
    	...
    	if (this.myWorld.myMarket.newEarnings) {
    		...
    		if (Math.random() < pRight && this.myWorld.myMarket.earningsManagement) {// ���ɹ�ʶ�𣬲������й�˾������ӯ������ʱ�򣬲Ż�ʶ������ӯ��ˮƽ
    ...
    private void initializeAgent() {
    	...
    	this.g1 = this.generateLaplace(0.8);
    	this.g2 = this.generateLaplace(0.1);
    	this.gn = this.generateLaplace(0.1);
