...
public class FinancialModelWithUI extends GUIState {
	...
	public void init(Controller c) {
		...
		priceChart.setRangeAxisRange(50,150);
		for (int a = 0; a < myModel.parameterMap.get("numAssets"); a++) {
			priceChart.addSeries(myReporter.informSeries.get(a), null);
			priceChart.addSeries(myReporter.tPriceSeries.get(a), null);
